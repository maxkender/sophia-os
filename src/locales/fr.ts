  ...
  translation: {
    ...
    ugc: {
      ...
      videos: {
        title: "Vidéos AI",
        subtitle:
          "Reactions (TikTok + trim) et utilisations (upload fichier). Après trim, seule la version courte est gardée.",
        bientot: "Bientôt — génération de vidéos UGC AI.",
        importTitre: "Importer une reaction",
        importDesc:
          "Colle un lien TikTok. Apify télécharge la vidéo, tu trims la durée, puis la version courte remplace l’original.",
        lien: "Lien TikTok",
        importer: "Importer",
        importEnCours: "Import Apify en cours…",
        titreChamp: "Titre",
        cropAide:
          "Coupe le début et la fin. À la validation, la vidéo entière est supprimée — seule la portion gardée reste.",
        resetCrop: "Toute la durée",
        validerEnregistrer: "Valider trim + enregistrer",
        trimRemplaceAide:
          "Irréversible : après validation, plus de re-trim — la version courte prend la place de l’original.",
        dejaFinalisee: "Cette reaction est déjà finalisée — pas de re-trim.",
        cropEnCours: "Encodage du trim…",
        frameEnCours: "Extraction 10ᵉ frame du segment (first_frame_reference)…",
        uploadEnCours: "Upload trim + frame…",
        ocrEnCours: "OCR → video_text…",
        videoCroppee: "Vidéo trimée",
        trimDebut: "Début",
        trimFin: "Fin",
        trimDuree: "{{sec}}s gardées",
        trimPreview: "Prévisualiser le segment",
        continuerTrim: "Continuer le trim",
        trimFige: "Trim figé — seule la version courte est stockée",
