...
export interface ButtonProps extends useRender.ComponentProps<"button"> {
  ...
  loading?: boolean;
  /** Compat shadcn/Radix : équivalent de `render`. */
  asChild?: boolean;
}
...
export function Button({
  ...
  if (!resolvedRender && asChild && React.isValidElement(children)) {
    const child = children as React.ReactElement<{ children?: React.ReactNode }>;
    const { children: childChildren, ...childProps } = child.props;
    resolvedRender = React.createElement(child.type, childProps);
    resolvedChildren = childChildren;
  }
