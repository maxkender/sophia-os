  ...
  translation: {
    ...
    ugc: {
      personas: {
        title: "Personas UGC",
        subtitle:
          "Génère un visage AI (9:16), valide pour créer 3 angles, puis enregistre le persona.",
        creerTitre: "Créer un persona",
        creerDesc:
          "Nano Banana Pro pour la face, puis Nano Banana Edit (3 angles en parallèle).",
