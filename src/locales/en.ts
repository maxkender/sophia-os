export const en = {
  translation: {
    ...
    nav: {
      ...
      creation: "Create a post",
      papier: "CM paper",
      reviews: "Reviews",
      fileReviews: "Today's queue",
      tests: "Tests",
      hiring: "Recruiting",
      embauche: "Create a poster",
      ugcPersonas: "UGC Personas",
      ugcSlideshows: "AI Slideshow",
      ugcVideos: "AI Videos",
      referral: "Referral",
      contratPapier: "Paper contract",
      recrutements: "Recruiting",
    },
    identite: {
    ...
    navDesc: {
      ...
      surveillance: "Struggling accounts and ending trials",
      ...
      fileReviews: "TikToks published today, to compare and review",
      ...
      recrutements: "HM and creator pipeline by country",
    },
    ugc: {
      personas: {
        title: "UGC Personas",
      ...
      slideshows: {
        title: "AI Slideshow",
        bientot: "Coming soon — UGC AI slideshow generation.",
      },
      videos: {
        title: "AI Videos",
        subtitle:
          "Reactions: after trim, storage = cropped video + 10th frame + OCR text. Utilisations = file upload.",
        bientot: "Coming soon — UGC AI video generation.",
        importTitre: "Import a reaction",
        importDesc:
          "TikTok link → duration trim. We only store the cropped video, the 10th frame, and the text read from that frame.",
        lien: "TikTok link",
        importer: "Import",
        importEnCours: "Apify import running…",
        titreChamp: "Title",
        labelChamp: "UGC AI VIDEO label",
        labelChoisir: "Pick a label…",
        labelAide: "Required to save — UGC AI VIDEO pool labels (Pilotage).",
        labelRequis: "Pick a UGC AI VIDEO label.",
        cropAide:
          "Cut start and end. The cut re-encodes the segment to H.264 (stream-copy would be a black screen). The full video is temporary only.",
        resetCrop: "Full duration",
        validerEnregistrer: "Confirm trim + save",
        trimRemplaceAide:
          "Stored after confirm: (1) cropped video (2) 10th frame image (3) video_text OCR. Nothing else — no re-trim.",
        dejaFinalisee: "This reaction is already finalized — no re-trim.",
        cropEnCours: "Cutting the video (H.264)…",
        frameEnCours: "Extracting 10th frame (first_frame_reference)…",
        uploadEnCours: "Uploading 10th frame…",
        ocrEnCours: "OCR frame → video_text…",
        videoCroppee: "Cropped video",
        trimDebut: "Start",
        trimFin: "End",
        trimDuree: "{{sec}}s kept",
        trimPreview: "Preview segment",
        continuerTrim: "Continue trim",
        trimFige: "Locked — stored: crop + 10th frame + video_text",
        listeTitre: "Saved reactions",
        listeVide: "No reaction yet.",
        confirmSuppr: "Delete “{{titre}}”?",
        utilTitre: "Import a utilisation",
        utilDesc: "Direct video file upload — stored as-is under Utilisations.",
        utilFichier: "Video file",
        utilTitrePlaceholder: "e.g. coffee transition",
        utilImporter: "Import file",
        utilUploadEnCours: "Uploading utilisation…",
        utilFichierRequis: "Pick a video file.",
        utilListeVide: "No utilisation yet.",
      },
    },
    simMinuit: {
    ...
    simPapier: {
      ...
      subtitle:
        "Draw a random unused FR master in ONE CM account’s language, as a test. Hidden from calendars.",
      compte: "CM account",
      ...
      aide: "If that language’s voice is missing, it is created now from the FR corpus. This does not overwrite the real assignment of the day.",
      ok: "{{count}} test assignment(s) created.",
      aucun: "Nothing to assign — no free master, or the language is still assembling.",
    ...
    simUgcVideoFace: {
      title: "UGC VIDEO test — through face-ref (0–2)",
      subtitle:
        "Reaction → clean frame10 (classic text-removal) → Nano Banana face-ref. No Kling, concat, or caption.",
      date: "Assignment date",
      compte: "UGC AI VIDEO creator",
      lancer: "Run through face-ref",
      enCours: "Clean + Nano Banana…",
      annuler: "Cancel test",
      annulerEnCours: "Cancelling…",
      annulerConfirm:
        "Delete this creator’s test videos for this date (storage + DB)?",
    ...
    reviews: {
      ...
      voirPost: "See the published TikTok",
      videoProgress: "Video {{current}} / {{total}}",
    },
    fileReviews: {
      title: "Today's queue",
      subtitle: "Slideshows marked published on {{date}} (Paris). Compare, review, or skip.",
      restants: "{{count}} in the queue",
      reglages: "Remarks",
      ...
      ajouter: "Add",
      videoVide: "Drop a 5–15s video here, or click to choose",
      videoRemplacer: "Replace video",
      videoGlisserAide: "Click to insert the text. Drop a short video on a remark to attach it.",
      videosJointes: "Videos that will play in sequence",
      videoSansTitre: "Video",
      videoErr: {
        type: "Use a video file (mp4, webm, mov).",
        taille: "The video is too large (max 30 MB).",
        duree: "Keep the clip under 20 seconds.",
      },
      vide: "Today's queue is empty",
      videAide: "Every TikTok published today has been reviewed or skipped.",
      ...
      remarquesComptees: "Remarks counted for this creator",
      historique: "Already sent to this creator (all their accounts)",
      historiqueFois: "{{n}}× {{titre}}",
      historiqueVide: "No generic remark sent to this creator yet.",
    ...
    minuit: {
      ...
      rattrapageEloAide:
        "Fetches views for published posts (last 4 days), updates language ELO (↑/↓) then requalifies account tiers.",
      ...
      rattrapageClassement: "Account tiers",
      ...
      rattrapageClassementRun:
        "{{examines}} account(s) requalified · {{changes}} change(s){{verrous}}",
      rattrapageClassementVerrous: " · {{n}} locked",
      rattrapageEloTopLangues: "Biggest language moves",
      rattrapageClassementCases: "Breakdown",
    ...
    pilotage: {
      ...
      totalVues: "total {{n}}",
      classementBasTitre: "Struggling accounts",
      classementBasDesc: "INACTIVE and POOR VIEWS — the watch queue.",
      classementTopTitre: "Accounts doing well",
      classementTopDesc: "GOOD and STAR tiers.",
      partBien: "{{pct}}% GOOD+",
      partBienAide: "Share of this recruiter's accounts rated GOOD or STAR",
    ...
    comptes: {
      ...
      ugcAiVideoAide:
        "UGC AI VIDEO mark + HM labels. Unique persona (shared pool with UGC AI slideshows).",
    ...
    papier: {
      title: "CM paper",
      subtitle:
        "Library of FR masters. At midnight each CM draws a random master not yet used in their language. Voice is created then.",
      aujourdHui: "Master in progress",
      aujourdHuiAide:
        "One master at a time: script, clips, FR voice, karaoke. When ready it joins the library — not tonight’s calendar.",
      aucunAujourdhui: "Nothing building. Start one for the library.",
      topic: "Topic",
      topicPh: "Leave empty, or propose an AI topic then approve it.",
      voix: "Voice",
      voixLangue: "Language",
      voixLocuteur: "Speaker",
      voixAide:
        "Pick a language first, then a speaker. French: Voix Narration Papier, Nova, Marishnou. Star saves a favorite.",
      voixFavori: "Favorite",
      voixEcouter: "Play a sample",
      voixStop: "Stop",
      voixChargement: "Loading ElevenLabs voices…",
      voixSansCle:
        "Set ELEVENLABS_API_KEY in Supabase secrets to play samples and see the rest of your library.",
      voixPreviewVide: "No sample for this voice.",
      voixPreviewErreur: "Could not play the sample.",
      duree: "Video duration",
      dureeAide: "Duration sets the number of shots. CTA is one short line.",
      plansEstimes: "≈ {{count}} shots",
      categorie: "Topic category",
      styleNarration: "Narration style",
      style: {
        question: "Big question",
        revelation: "Reveal",
        storytelling: "Immersive story",
      },
      styleAide: {
        question: "“But do you really know why…?”",
        revelation: "Clues, then a final twist",
        storytelling: "We tell the scene as it was lived",
      },
      cat: {
        aleatoire: "Random",
        psychologie: "Psychology",
        corps: "Body & brain",
        sommeil: "Sleep & dreams",
        nourriture: "Food",
        argent: "Money",
        tech: "Phone & internet",
        societe: "Social norms",
        relations: "Relationships",
        sport: "Sports",
        langage: "Words & language",
        histoire: "History (famous)",
        faits_divers: "Odd news",
        mythes: "Famous myths",
        science: "Everyday science",
        espace: "Space",
        animaux: "Animals",
        geographie: "Geography",
        pop_culture: "Movies & pop culture",
        origines: "Origins of stuff",
        personnages: "Famous people",
        mysteres: "Famous mysteries",
      },
      mode: "Pipeline mode",
      modeAuto: "Automatic",
      modeManuel: "Manual",
      ...
      validerScript: "Approve script",
      validerImages: "Approve photos",
      arreter: "Stop pipeline",
      pipeline: "Pipeline",
      holdTopic: "Topic proposed — review it, then approve to write the script.",
      holdScript: "Script ready — review the hook and story, then approve to generate photos.",
      holdImages: "Photos ready — review them, then approve to animate the shots.",
      regenererScript: "Regenerate script",
      regenererImages: "Regenerate photos",
      scriptHook: "Hook",
      scriptCta: "CTA",
      etape: {
        topic: "Topic",
      ...
      vide: "The library is empty. Advance the pipeline to create the first FR master.",
      videAide: "A master = script + clips + FR voice + karaoke. Other languages are born at assignment.",
      enBiblio: "In library",
      ...
      nouveauMaster: "Prepare a master",
      nouveauMasterAide: "Build a complete FR master for the library. Nothing posts tonight.",
      minuit: "Midnight assignment",
      minuitAide:
      ...
      voirPlans: "Shots",
      voirLangues: "Assembled languages",
      fermer: "Close",
      ouvrir: "Open",
      echecs: "Failures",
      actions: "Actions",
      sansTopic: "Topic pending",
      plans: "{{count}} shot(s)",
      plan: "Shot {{n}}",
      planAttente: "Waiting…",
      statut: {
      ...
      assignerAide:
        "Each active CM draws a random free master in their language. Missing voice is generated then. If none left: an original starts.",
      assignes: "{{count}} CM account(s) assigned",
      enPause: "Paper paused — cron will not start. You can still advance it by hand.",
      quotaFal: "Fal quota today: {{n}} / {{max}}",
      quotaFalIllimite: "Fal today: {{n}} calls (unlimited)",
      reglagesLien: "Paper settings",
      statutLangue: {
        queued: "Queued",
    ...
    papierContrat: {
      titre: "Paper CM contract (Instagram)",
      sous: "Read the agreement (English is the governing language), sign, then create the Gmail and Instagram account with the exact credentials.",
      videTitre: "No Paper contract yet",
      videAide: "When an admin picks you as a Paper CM, the contract shows up here.",
      signerTitre: "Signature",
      signerAide: "Type your legal name as the signature. We also store the date, time and IP.",
      nomLegal: "Full legal name",
      pays: "Country of residence",
      signature: "Signature (same name)",
      signaturePh: "First Last",
      signatureAide: "Must match your legal name exactly.",
      caseLu: "I have read the Social Media Services and Account Ownership Agreement.",
      caseAccepte:
        "I agree: the Instagram accounts and email belong to VIK STUDIOS from the moment they are created. I am only a custodian.",
      signer: "Sign the agreement",
      societe: "VIK STUDIOS SAS — Maximilien Kender, President, already signed for the company.",
      signeTitre: "Agreement signed",
      signeAide: "Now create the Gmail then Instagram, using these exact names and passwords. Send the credentials within 24 hours.",
      gmail: "Gmail to create",
      gmailMdp: "Gmail password",
      instagram: "Instagram username",
      instagramMdp: "Instagram password",
      etape1: "Create the exact Gmail (Google) with this password.",
      etape2: "Create Instagram with the exact @ and this password.",
      etape3: "Store Gmail + Instagram + 2FA codes in Bitwarden (company vault).",
      etape4: "Do not change email, password or 2FA without written approval.",
      preuve: "Record: {{nom}} · {{pays}} · {{date}} · IP {{ip}}",
      ...
      errSignature: "The signature must match your legal name exactly.",
      errCases: "Tick both boxes to sign.",
      errIntrouvable: "Contract not found or already signed.",
      errAuth: "Sign in again to sign.",
    },
    cm: {
      badge: "CM",
      ...
      videoDuJour: "Paper video",
      telecharger: "Download video",
      copierCaption: "Copy caption",
      copierHashtags: "Copy hashtags",
      copieOk: "Copied",
      jourSelectionne: "{{date}}",
      calendrierLegende: "Click a day to view and download the paper video.",
    },
    posters: {
      title: "Posters",
      ...
      ugcAiVideoBadge: "UGC AI VIDEO",
      ugcAiVideoSansLabels: "UGC AI VIDEO mark — no thematic labels.",
      hmUgcAiVideo: "UGC AI VIDEO hiring manager",
      hmUgcAiVideoBadge: "HM UGC AI VIDEO",
      hmUgcAiVideoAide:
        "Their creators are born with the UGC AI VIDEO mark + the labels chosen here, and a unique persona (unavailable if already used by a slideshow or video account).",
      ...
      partBien: "{{pct}}% GOOD+",
      partBienAide: "Share of this recruiter's creators rated GOOD or STAR",
    ...
    hiring: {
      ...
      langueAide:
        "Pick THIS creator’s language. Every target language is available: hiring in a new one adds it to the languages you manage.",
    ...
    creation: {
      title: "Create a post",
      subtitle:
        "Pick a label, an existing hook, and the slide count. The AI writes the rest; images are drawn from the label library.",
      parametres: "Settings",
      parametresDesc: "Label, slide count, ELO (all languages) and extra instruction.",
      label: "Label",
      choisirLabel: "Choose a label",
      nbSlides: "Number of slides",
      elo: "ELO",
      eloAide: "Default 65, applied to every language.",
      promptExtra: "Extra prompt",
      promptExtraPh: "e.g. mysterious art direction, assertive tone…",
      labelPrepare: "This label has a style / prompt.",
      labelVide: "No style or prompt yet for this label.",
      editerLabel: "Edit in Dashboard",
      hook: "Hook",
      hookDesc:
        "First-slide caption of slideshows in this label. Music is taken from the original post.",
      hookRecherche: "Search a hook…",
      dabordLabel: "Pick a label first.",
      hookVide: "No hook found for this label (import or label some slideshows).",
      hookRequis: "Pick a hook.",
      musique: "Music: {{titre}}",
      imageHook: "Hook image (pinned)",
      imageHookAide:
        "From photos of this label that also carry the Hook label. Change it until you like one.",
      imageHookVide: "No Hook image in this label’s library.",
      generer: "Generate slides",
      generation: "Generating…",
      apercu: "Draw preview",
      apercuDesc:
        "Slide 1 = pinned Hook image. Later slides = caption search (subject + tone); the image is resolved at assignment. You can pin a specific photo.",
      retirer: "New draw",
      sansImage: "No image",
      pinned: "Pinned",
      critereLive: "Criterion",
      fallback: "Random fallback",
      changerImage: "Pick an image",
      pin: "Pin",
      unpin: "Unpin",
      ...
      biblioVide: "No non-Hook image in this label.",
      valider: "Validate slideshow",
      voirSlideshow: "Open the created slideshow",
    },
    contenus: {
      title: "Content pool",
    ...
    slideshows: {
      ...
      tierlist: "Tierlist",
      tierlistAide:
        "The tier sets how many passes a post owes (D 0 · C 1 · B 2 · A 4 · S 8 · S+ 16). Once they are all published the post is requalified on m, the mean of their views. A manual change restarts a fresh cycle — the next requalification takes over again.",
      tierPassages_one: "{{count}} pass to run",
      ...
      noteImport: "Import score",
      eloVide: "No score yet (rejected or still importing).",
      origine: "origin",
      nbPassages_one: "{{count}} passage",
      nbPassages_other: "{{count}} passages",
      decks: "Decks (by language)",
      decksVide: "No deck produced yet (still importing or never assigned).",
    ...
    reglages: {
      ...
      actionEloDesc:
        "Active ELO catch-up: scrape → language deltas → account tiers. Midnight « scores » runtime is paused.",
      ...
      classementParams: "Account tiers",
      classementParamsAide:
        "Requalification thresholds for accounts (INACTIVE → STAR), applied every night after views are collected. Window = the last N posts.",
      clFenetre: "Window (last posts)",
      clMinEchantillon: "Minimum sample",
      clMinEchantillonAide:
        "Below this many planned (or measured) posts the account stays OK — a brand-new account is not judged.",
      clRatioInactif: "INACTIVE if posted ≤ (out of 10)",
      clRatioBien: "GOOD if posted ≥ (out of 10)",
      clRatioStar: "STAR if posted ≥ (out of 10)",
      clVuesMauvaises: "POOR VIEWS below (views)",
      clVuesBien: "GOOD from (views)",
      clVuesStar: "STAR above (views)",
      clTrialHeures: "Trial length (hours)",
      clTrialAlerte: "Enters the watch queue before the end (hours)",
      clSkipJours: "Skip length (days)",
      nudgesTitre: "Preset messages (nudges)",
      nudgesAide:
        "Messages you can send from the watch page. They land in the creator's space.",
      nudgeTitreChamp: "Title",
      nudgeCorpsChamp: "Message",
      nudgeAjouter: "Add a message",
      nudgeSupprimer: "Remove",
      nudgeVide: "No preset message.",
      ...
      actionPapier: "CM paper",
      actionPapierDesc:
        "FR master library: duration, ElevenLabs voice, auto pause, Fal cap.",
      papierPause: "Pause paper (cron + auto-chain)",
      papierPauseAide:
        "Midnight no longer assigns or creates a fallback original. Buttons on /admin/papier still work. The Fal quota still applies.",
      papierDuree: "Duration",
      papierDureeSec: "Target duration (seconds)",
      papierDureeClip: "Seedance shot length",
      papierClipAuto: "Auto (from the text)",
      papierDureeAide: "20–90 s total. Auto sizes each shot to the text (4–15 s), then trims to the voice.",
      papierVoix: "ElevenLabs voices",
      papierVoixDefaut: "Default voice",
      papierVoixSuivre: "Follow default",
      papierVoixFavoris:
        "Language first, then speaker. FR: Narration Papier, Nova, Marishnou. EN: Peter, Brady. Stars on the Paper page pin favorites.",
      papierCategorie: "Default topic category",
      papierStyle: "Default narration style",
      papierMode: "Default pipeline mode",
      papierQuota: "Fal quota / day (0 = unlimited)",
      papierQuotaAide: "Counts Nano Banana, Seedance, TTS, mix, assemble and karaoke.",
      papierQuotaUsage: "{{n}} / {{max}} calls today",
      papierQuotaIllimite: "{{n}} calls today (unlimited)",
    ...
    prompts: {
      scriptGenerationTitle: "Prompt — Script generation",
      scriptGenerationDesc: "Topic choice, script structure and shot breakdown.",
      voiceDeliveryTitle: "Prompt — Voice & pacing",
      voiceDeliveryDesc: "Speed, tone and breathing of the voice-over.",
      ctaSophiaTitle: "Prompt — Sophia CTA",
      ctaSophiaDesc: "The closing line that points to the Sophia app.",
      imageStyleTitle: "Prompt — Image style",
      imageStyleDesc: "Art direction applied to every generated shot.",
    ...
    classement: {
      inactif: "INACTIVE",
      mauvaises_vues: "POOR VIEWS",
      passable: "OK",
      bien: "GOOD",
      star: "STAR",
      aide: "Account tier, requalified every night on its last 10 posts",
      maj: "Requalified {{date}}",
      jamais: "Not requalified yet",
      verrou: "Tier set by hand",
      calcule: "Computed: {{case}}",
      rapportPosts: "{{postes}}/{{prevus}} posts published",
      rapportVues: "{{vues}} views on average",
      nonDeclares: "{{n}} published without being declared",
      infirmes: "{{n}} ticked, never found on TikTok",
    },
    surveillance: {
      title: "Account watch",
      subtitle:
        "Accounts flagged INACTIVE or POOR VIEWS, plus trials about to end. Requalified every night, after views are collected.",
      fileTitre: "Watch queue",
      fileDesc:
        "An account lands here as soon as it is INACTIVE or POOR VIEWS, and always 30 h before its trial ends.",
      fileVide: "Queue is empty — every tracked account is at least OK.",
      nonRenouvTitre: "Do not renew",
      nonRenouvDesc:
        "Accounts proposed for non-renewal. No technical effect: they keep receiving posts until you deactivate them.",
      nonRenouvVide: "No account proposed for non-renewal.",
      compteur: "{{n}} account(s)",
      ...
      annulerSkip: "Cancel skip",
      changerCase: "Change tier",
      changerCaseAide:
        "Sets the tier by hand and locks the account: the nightly requalification will not overwrite it.",
      deverrouiller: "Back to auto",
      deverrouillerAide: "The account takes the computed tier again at the next requalification.",
      nudge: "Nudge",
      nudgeAide: "Drops an in-app message the creator sees in their space.",
      nudgeAucunModele: "No preset message — add some in Settings.",
      nudgeEnvoye: "Message sent to {{nom}}.",
      nudgeDernier: "Last nudge {{date}}",
      nePasRenouveler: "Do not renew",
      nePasRenouvelerAide: "Adds the account to the non-renewal list (nothing is cut off).",
      retirerNonRenouv: "Remove from list",
      hmDemande: "I asked the HM not to renew this account",
    ...
    adminCreateur: {
      ...
      voirSurveillance: "Account watch",
    ...
    recrutements: {
      title: "Recruiting",
      subtitle:
        "Hiring-manager and creator pipeline, by OS country. Replaces the Google Sheet.",
      dernierRun: "Last autom run: {{date}}",
      erreurCharge: "Could not load Recruiting.",
      compteursPays: "0 · {{p0}}   1 · {{p1}}   2 · {{p2}}",
      retour: "All countries",
      resumePays: "{{hms}} HM · {{createurs}} creators",
      cibleHm: "Creator target",
      tousPostes: "Every creator in this country has posted — see Follow-up.",
      ficheCreateur: "Creator card",
      ficheEmail: "Email",
      ficheTiktok: "TikTok account",
      ficheLabels: "Labels",
      ficheAucunTiktok: "No TikTok account yet.",
      ficheAucunLabel: "No labels",
      ficheOuvrirCompte: "Open account",
      phase0: "Phase 0 — Hire the HM",
      phase1: "Phase 1 — HM is hiring",
      phase2: "Phase 2 — Follow-up",
      phaseCourt: "Phase {{n}}",
      phaseTitre0: "Hire the HM",
      phaseTitre1: "HM is hiring",
      phaseTitre2: "Follow-up",
      pill0: "Hiring",
      pill1: "Recruiting",
      pill2: "Follow-up",
      createursCibleLabel: "Creators",
      createursCible: "{{n}} / {{cible}}",
      colPosts: "Posts 10d",
      colVues: "Avg views",
      colCpm: "$ / 1k",
      videPhase: "Nobody here yet.",
      copier: "Copy",
      copie: "Copied",
      emailPerso: "Personal email",
      emailPersoAide: "To add them to the Upwork team (admin copy-paste).",
      ajouteUpwork: "Added to the Upwork team (manual)",
      nCreateurs_one: "{{count}} creator",
      nCreateurs_other: "{{count}} creators",
      aucunCreateurPipeline: "No creator in this country yet — follow up on the job post.",
      inboxTitre: "Suggestions inbox",
      inboxCarte: "Suggestion",
      ouvrirDetails: "Details",
      replier: "Collapse",
      nAValider_one: "{{count}} to review",
      nAValider_other: "{{count}} to review",
      dernierMessage: "Last Upwork message",
      ...
      etapesManuelles: "Steps (tick by hand)",
      etapesManuellesAide:
      ...
      etape0Aide: {
        talks: "First real Upwork exchange (invite or unsolicited proposal).",
        contrat_envoye: "Hourly $8/h contract sent on Upwork.",
        contrat_signe: "The HM signed the hourly contract.",
        acces: "Create the OS account, send codes, Slack invite, and ask for a personal email.",
        checklist: "They joined Slack and OS, and you added them to the Upwork team.",
        job_post: "They posted a job on the Vik Studios org.",
      },
      etapeCreAide: {
        talks: "First exchange with this creator, in this country / language.",
        contrat: "Creator contract sent then signed (trial $15, then $60/month).",
        acces: "OS codes + Slack invite sent to the creator.",
        rejoint: "The creator joined OS and Sophia Slack.",
        warmup: "The country account is in warmup (or finished it).",
        premier_post: "First published post (non-test) on an account in this country.",
      },
      sous: {
        codes: "OS codes sent",
        slackInvite: "Slack invite sent",
        emailDemande: "Personal email asked",
        rejointOs: "Joined OS",
        rejointSlack: "Joined Slack",
        contratEnvoye: "Contract sent",
        contratSigne: "Contract signed",
      },
      valider: "Approve",
      reproposer: "Rewrite",
      ignorer: "Ignore",
      faitManuellement: "Done manually",
      relancer: "Nudge",
      pression: "Pressure",
      ...
      etapeCre: {
        ...
        rejoint: "Joined",
        warmup: "Warmup",
        premier_post: "1st post",
      },
      statut: {
        en_attente: "To approve",
        validee: "Approved",
        ignoree: "Ignored",
        executee: "Done",
        a_reproposer: "Rewrite",
      },
      ton: {
        ok: "OK",
        volume: "Under quota",
        vues: "0 views",
        doux: "Under quota, high views",
      },
    },
    referral: {
