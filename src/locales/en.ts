export const en = {
  translation: {
    ...
    cm: {
      ...
      ajouterCompteAide:
        "One creator = one login. You can attach several publishing TikTok accounts.",
      ajouterPersoAide:
    ...
    hiring: {
      ...
      creerHmDesc:
        "Same login and same initial password as an HM. You set their languages.",
    ...
    labels: {
      ...
      gestionDesc:
        "Bridge between contents and creators.",
      nom: "Name",
      couleur: "Color",
      genre: "Gender",
      genreHomme: "Male",
