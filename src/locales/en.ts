  ...
  translation: {
    ...
    ugc: {
      ...
      videos: {
        ...
        cropAide:
          "Cut start and end. The server trims the original TikTok without re-encoding (FPS / quality kept). The full video is temporary only.",
        ...
        cropEnCours: "Server trim (lossless copy, no re-encode)…",
