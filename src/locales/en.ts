export const en = {
  translation: {
    ...
    papier: {
      ...
      modeManuel: "Manual",
      modeAide:
        "Automatic: everything runs. Manual: you approve the topic, then the script, then editing starts.",
      ...
      holdScript: "Script ready — review the hook and story, then start editing.",
      scriptHook: "Hook",
      scriptCta: "CTA",
      etape: {
        topic: "Topic",
