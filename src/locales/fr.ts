export const fr = {
  translation: {
    ...
    navDesc: {
      ...
      slideshows: "Tous les slideshows importés — ELO, passages, stats",
    ...
    slideshows: {
      title: "Slideshows",
      subtitle:
        "Tous les TikToks importés (v-next). Clique pour voir l'ELO par langue, les dates de passage et les stats.",
