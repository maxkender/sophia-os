  ...
  translation: {
    ...
    ugc: {
      ...
      videos: {
        title: "AI Videos",
        subtitle:
          "Reactions (TikTok + trim) and utilisations (file upload). After trim, only the short version is kept.",
        bientot: "Coming soon — UGC AI video generation.",
        importTitre: "Import a reaction",
        importDesc:
          "Paste a TikTok link. Apify downloads the video, you trim the duration, then the short version replaces the original.",
        lien: "TikTok link",
        importer: "Import",
        importEnCours: "Apify import running…",
        titreChamp: "Title",
        cropAide:
          "Cut start and end. On confirm, the full video is deleted — only the kept segment remains.",
        resetCrop: "Full duration",
        validerEnregistrer: "Confirm trim + save",
        trimRemplaceAide:
          "Irreversible: after confirm, no re-trim — the short version replaces the original.",
        dejaFinalisee: "This reaction is already finalized — no re-trim.",
        cropEnCours: "Encoding trim…",
        frameEnCours: "Extracting 10th frame of the segment (first_frame_reference)…",
        uploadEnCours: "Uploading trim + frame…",
        ocrEnCours: "OCR → video_text…",
        videoCroppee: "Trimmed video",
        trimDebut: "Start",
        trimFin: "End",
        trimDuree: "{{sec}}s kept",
        trimPreview: "Preview segment",
        continuerTrim: "Continue trim",
        trimFige: "Trim locked — only the short version is stored",
