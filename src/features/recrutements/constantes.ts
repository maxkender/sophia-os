...
export const PASTEL_PAYS: Record<string, string> = {
  ...
  da: "bg-red-50/60 hover:bg-red-50",
  no: "bg-indigo-50/90 hover:bg-indigo-50",
  ru: "bg-sky-50/70 hover:bg-sky-50",
  hr: "bg-rose-50/80 hover:bg-rose-50",
  sl: "bg-blue-50/70 hover:bg-blue-50",
  sk: "bg-sky-50/80 hover:bg-sky-50",
  sr: "bg-violet-50/80 hover:bg-violet-50",
  ar: "bg-emerald-50/80 hover:bg-emerald-50",
