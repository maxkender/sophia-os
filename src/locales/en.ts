export const en = {
  translation: {
    ...
    papier: {
      ...
      voixAide:
        "Pick a language first, then an ElevenLabs speaker. locuteur-cm (your library) is pinned at the top for French. Star saves a favorite.",
      voixFavori: "Favorite",
      voixEcouter: "Play a sample",
      voixStop: "Stop",
      voixChargement: "Loading ElevenLabs voices…",
      voixSansCle:
        "Set ELEVENLABS_API_KEY in Supabase secrets to see your library (locuteur-cm) and more French voices.",
    ...
    reglages: {
      ...
      papierDureeAide: "20–90 s total. Auto picks 4, 6 or 8 s per shot.",
      papierVoix: "ElevenLabs voices",
      papierVoixDefaut: "Default voice",
      papierVoixSuivre: "Follow default",
      papierVoixFavoris:
        "Language first, then speaker. locuteur-cm comes from your ElevenLabs library. Stars on the Paper page pin favorites.",
