export const fr = {
  translation: {
    ...
    nav: {
      ...
      comptes: "Comptes",
      posters: "Posters",
      surveillance: "Surveillance comptes",
      ...
      creation: "Créer un post",
      papier: "Papier CM",
      reviews: "Reviews",
      fileReviews: "File du jour",
      tests: "Tests",
      hiring: "Recrutement",
    ...
    navDesc: {
      ...
      surveillance: "Comptes à problème et fins d'essai",
      ...
      fileReviews: "TikToks publiés aujourd’hui, à comparer et reviewer",
      ...
      recrutements: "Pipeline HM et créateurs par pays",
    },
    ugc: {
      personas: {
        title: "Personas UGC",
    ...
    simPapier: {
      ...
      subtitle:
        "Tire au hasard un master FR pas encore utilisé dans la langue de UN compte CM, en test. Invisible sur les calendriers.",
      compte: "Compte CM",
      ...
      aide: "Si la voix de cette langue n’existe pas encore, elle se crée maintenant (à partir du corpus FR). Ça n’écrit pas sur l’assignation réelle du jour.",
      ok: "{{count}} assignation(s) test créée(s).",
      aucun: "Rien à assigner — aucun master libre, ou la langue est encore en cours.",
    ...
    reviews: {
      ...
      voirPost: "Voir le TikTok publié",
      videoProgress: "Vidéo {{current}} / {{total}}",
    },
    fileReviews: {
      title: "File du jour",
      subtitle: "Slideshows marqués publiés le {{date}} (Paris). Compare, review, ou passe.",
      restants: "{{count}} dans la file",
      reglages: "Remarques",
      ...
      ajouter: "Ajouter",
      videoVide: "Glisse une vidéo de 5–15 s ici, ou clique pour choisir",
      videoRemplacer: "Remplacer la vidéo",
      videoGlisserAide: "Clique pour insérer le texte. Glisse une courte vidéo sur une remarque pour la lier.",
      videosJointes: "Vidéos jouées à la suite",
      videoSansTitre: "Vidéo",
      videoErr: {
        type: "Dépose un fichier vidéo (mp4, webm, mov).",
        taille: "La vidéo est trop lourde (max 30 Mo).",
        duree: "La vidéo doit durer moins de 20 secondes.",
      },
      vide: "File du jour vide",
      videAide: "Tous les TikToks publiés aujourd’hui ont été reviewés ou passés.",
      original: "TikTok d’origine",
      ...
      remarquesComptees: "Remarques comptées pour ce créateur",
      historique: "Déjà envoyé à ce créateur (tous ses comptes)",
      historiqueFois: "{{n}}× {{titre}}",
      historiqueVide: "Aucune remarque générique envoyée à ce créateur.",
    ...
    minuit: {
      ...
      rattrapageEloAide:
        "Relève les vues des posts publiés (4 derniers jours), met à jour l’ELO langue (↑/↓) puis requalifie le classement des comptes.",
      ...
      rattrapageClassement: "Classement des comptes",
      ...
      rattrapageClassementRun:
        "{{examines}} compte(s) requalifié(s) · {{changes}} changement(s){{verrous}}",
      rattrapageClassementVerrous: " · {{n}} verrou(s)",
      rattrapageEloTopLangues: "Plus gros mouvements langue",
      rattrapageClassementCases: "Répartition",
    ...
    pilotage: {
      ...
      totalVues: "total {{n}}",
      classementBasTitre: "Comptes à problème",
      classementBasDesc: "INACTIF et MAUVAISES VUES — la file de surveillance.",
      classementTopTitre: "Comptes qui marchent",
      classementTopDesc: "Les cases BIEN et STAR.",
      partBien: "{{pct}} % en BIEN+",
      partBienAide: "Part des comptes du recruteur en BIEN ou STAR",
    ...
    papier: {
      title: "Papier CM",
      subtitle:
        "Bibliothèque de masters FR. À minuit, chaque CM tire un master au hasard, pas encore utilisé dans sa langue. La voix se crée alors.",
      aujourdHui: "Master en cours",
      aujourdHuiAide:
        "Un master à la fois : script, clips, voix FR, karaoké. Une fois prêt, il rejoint la bibliothèque — pas le calendrier du soir.",
      aucunAujourdhui: "Rien en fabrication. Tu peux en lancer un pour la bibliothèque.",
      topic: "Sujet",
      topicPh: "Laisser vide, ou proposer un sujet IA puis valider.",
      voix: "Voix",
      voixLangue: "Langue",
      voixLocuteur: "Locuteur",
      voixAide:
        "Choisis d’abord la langue, puis un locuteur. En français : Voix Narration Papier, Nova, Marishnou. L’étoile enregistre un favori.",
      voixFavori: "Favori",
      voixEcouter: "Écouter un extrait",
      voixStop: "Arrêter",
      voixChargement: "Chargement des voix ElevenLabs…",
      voixSansCle:
        "Ajoute ELEVENLABS_API_KEY dans les secrets Supabase pour écouter les extraits et voir le reste de ta bibliothèque.",
      voixPreviewVide: "Aucun extrait pour cette voix.",
      voixPreviewErreur: "Impossible de lire l’extrait.",
      duree: "Durée de la vidéo",
      dureeAide: "La durée fixe le nombre de plans. CTA = une phrase.",
      plansEstimes: "≈ {{count}} plans",
      categorie: "Catégorie du sujet",
      styleNarration: "Style de narration",
      style: {
      ...
      cat: {
        ...
        corps: "Corps & cerveau",
        sommeil: "Sommeil & rêves",
        nourriture: "Nourriture",
        argent: "Argent",
        tech: "Téléphone & internet",
        societe: "Société & normes",
        relations: "Relations",
        sport: "Sport",
        langage: "Mots & langage",
        histoire: "Histoire (connue)",
        faits_divers: "Faits divers",
        mythes: "Mythes connus",
        science: "Science du quotidien",
        espace: "Espace",
        animaux: "Animaux",
        geographie: "Géographie",
        pop_culture: "Films & pop culture",
        origines: "Origines des objets",
        personnages: "People connues",
        mysteres: "Mystères célèbres",
      },
      mode: "Mode pipeline",
      ...
      validerScript: "Valider le script",
      validerImages: "Valider les photos",
      arreter: "Arrêter la pipeline",
      pipeline: "Pipeline",
      holdTopic: "Sujet proposé — relis-le, puis valide pour écrire le script.",
      holdScript: "Script prêt — relis le hook et l’histoire, puis valide pour générer les photos.",
      holdImages: "Photos prêtes — relis-les, puis valide pour monter les plans.",
      regenererScript: "Regénérer le script",
      regenererImages: "Regénérer les photos",
      scriptHook: "Hook",
      scriptCta: "CTA",
      etape: {
        topic: "Sujet",
      ...
      vide: "La bibliothèque est vide. Avance le pipeline pour créer le premier master FR.",
      videAide: "Un master = script + clips + voix FR + karaoké. Les autres langues naissent à l’assignation.",
      ...
      libre: "Libre",
      nMasters: "{{count}} master(s)",
      nouveauMaster: "Préparer un master",
      nouveauMasterAide:
        "Fabrique un master FR complet pour la bibliothèque. Ça ne poste rien ce soir.",
      minuit: "Assignation de minuit",
      minuitAide:
        "Chaque CM actif tire un master libre au hasard dans sa langue. S’il manque la voix, elle se génère. Plus rien : un original démarre.",
      voirPlans: "Plans",
      voirLangues: "Langues assemblées",
      fermer: "Fermer",
      ouvrir: "Ouvrir",
      echecs: "Échecs",
      actions: "Actions",
      sansTopic: "Sujet en attente",
      plans: "{{count}} plan(s)",
      plan: "Plan {{n}}",
      planAttente: "En attente…",
      statut: {
        queued: "En file",
        scripting: "Script",
        images: "Images",
      ...
      assignes: "{{count}} compte(s) CM assigné(s)",
      enPause: "Papier en pause — le cron ne lance plus. Tu peux encore avancer à la main.",
      quotaFal: "Quota Fal aujourd’hui : {{n}} / {{max}}",
      quotaFalIllimite: "Fal aujourd’hui : {{n}} appels (illimité)",
      reglagesLien: "Réglages papier",
      statutLangue: {
        queued: "En file",
    ...
    papierContrat: {
      titre: "Contrat Paper CM (Instagram)",
      sous: "Lis le contrat (en anglais, langue officielle), signe, puis crée le Gmail et le compte Instagram avec les identifiants fournis.",
      videTitre: "Pas de contrat Paper pour l’instant",
      videAide: "Quand un admin te choisit comme CM Paper, le contrat apparaît ici.",
      signerTitre: "Signature",
      signerAide: "Tape ton nom légal exactement comme signature. Ça enregistre aussi la date, l’heure et l’IP.",
      nomLegal: "Nom légal complet",
      pays: "Pays de résidence",
      signature: "Signature (même nom)",
      signaturePh: "Prénom Nom",
      signatureAide: "Doit être identique à ton nom légal.",
      caseLu: "J’ai lu le Social Media Services and Account Ownership Agreement.",
      caseAccepte:
        "J’accepte : les comptes Instagram et l’email appartiennent à VIK STUDIOS dès leur création. Je n’en suis que gardien.",
      signer: "Signer le contrat",
      societe: "VIK STUDIOS SAS — Maximilien Kender, Président, déjà signé pour la société.",
      signeTitre: "Contrat signé",
      signeAide: "Crée maintenant le Gmail puis Instagram, avec ces noms et mots de passe exacts. Envoie les accès sous 24 h.",
      gmail: "Gmail à créer",
      gmailMdp: "Mot de passe Gmail",
      instagram: "Identifiant Instagram",
      instagramMdp: "Mot de passe Instagram",
      etape1: "Crée le Gmail exact (Google), avec ce mot de passe.",
      etape2: "Crée Instagram avec le @ exact et le même mot de passe.",
      etape3: "Range Gmail + Instagram + codes 2FA dans Bitwarden (coffre de la boîte).",
      etape4: "Ne change rien (mail, mdp, 2FA) sans accord écrit.",
      preuve: "Preuve : {{nom}} · {{pays}} · {{date}} · IP {{ip}}",
      ...
      errSignature: "La signature doit être exactement ton nom légal.",
      errCases: "Coche les deux cases pour signer.",
      errIntrouvable: "Contrat introuvable ou déjà signé.",
      errAuth: "Reconnecte-toi pour signer.",
    },
    cm: {
      badge: "CM",
      ...
      videoDuJour: "Vidéo papier",
      telecharger: "Télécharger la vidéo",
      copierCaption: "Copier la légende",
      copierHashtags: "Copier les hashtags",
      copieOk: "Copié",
      jourSelectionne: "{{date}}",
      calendrierLegende: "Clique un jour pour voir et télécharger la vidéo papier.",
    },
    posters: {
      title: "Posters",
      ...
      partBien: "{{pct}} % en BIEN+",
      partBienAide: "Part des créateurs de ce recruteur en BIEN ou STAR",
    ...
    hiring: {
      ...
      langueAide:
        "Choisis la langue de CE créateur. Toutes les langues cibles sont ouvertes : si tu embauches dans une nouvelle, elle s’ajoute à tes langues gérées.",
      ...
      calendrierLegende: "Une couleur par créateur. ✓ = publié. Estompé = en cours de fabrication. Clique un post pour l'aperçu. Badge CM = vidéo papier.",
      apercuTitre: "Aperçu du post",
      apercuPapier: "Vidéo papier CM",
    ...
    labels: {
      ...
      styleTheme: "Thème / style",
      styleThemeAide: "Voix, univers, format des conseils — ce que le modèle doit imiter.",
      promptCreation: "Prompt du label",
      promptCreationAide: "Consigne dédiée (en plus du prompt système « creation_semi_manuelle »).",
      feed: "Feed d’exemples",
      feedAide: "Quelques textes déjà rédigés. Un exemple par paragraphe (ligne vide).",
      enregistrerStyle: "Enregistrer le style",
      creerPost: "Créer un post",
    },
    creation: {
      title: "Créer un post",
      subtitle:
        "Choisis un label, un hook existant, le nombre de slides. L’IA rédige la suite ; les images se tirent dans la bibliothèque du label.",
      parametres: "Paramètres",
      parametresDesc: "Label, nombre de slides, ELO (toutes langues) et consigne extra.",
      label: "Label",
      choisirLabel: "Choisir un label",
      nbSlides: "Nombre de slides",
      elo: "ELO",
      eloAide: "Défaut 65, appliqué à toutes les langues.",
      promptExtra: "Prompt supplémentaire",
      promptExtraPh: "Ex. DA mystérieuse, ton affirmatif…",
      labelPrepare: "Ce label a un style / prompt.",
      labelVide: "Pas encore de style ni de prompt pour ce label.",
      editerLabel: "Éditer dans Pilotage",
      hook: "Hook",
      hookDesc:
        "Caption de la première slide des slideshows de ce label. La musique reprise est celle du post original.",
      hookRecherche: "Rechercher un hook…",
      dabordLabel: "Choisis d’abord un label.",
      hookVide: "Aucun hook trouvé pour ce label (importe ou labellise des slideshows).",
      hookRequis: "Choisis un hook.",
      musique: "Musique : {{titre}}",
      imageHook: "Image du hook (figée)",
      imageHookAide:
        "Parmi les photos du label qui portent aussi le label Hook. Tu peux en changer jusqu’à en trouver une bonne.",
      imageHookVide: "Aucune image Hook dans la bibliothèque de ce label.",
      generer: "Générer les slides",
      generation: "Génération…",
      apercu: "Aperçu du tirage",
      apercuDesc:
        "Slide 1 = image Hook pinnée. Slides suivantes = critère caption (sujet + ton) ; l’image se résout à l’assignation. Tu peux pinner une photo précise.",
      retirer: "Nouveau tirage",
      sansImage: "Pas d’image",
      pinned: "Pinnée",
      critereLive: "Critère",
      fallback: "Fallback aléatoire",
      changerImage: "Choisir une image",
      pin: "Épingler",
      unpin: "Dé-pinner",
      slideHook: "Slide 1 — hook",
      slideN: "Slide {{n}}",
      critere: "Critère d’image",
      criterePh: "coffee dark tones",
      biblioVide: "Aucune image (hors Hook) dans ce label.",
      valider: "Valider le slideshow",
      voirSlideshow: "Ouvrir le slideshow créé",
    },
    contenus: {
    ...
    slideshows: {
      ...
      tierlist: "Tierlist",
      tierlistAide:
        "Le rang décide du nombre de passages à effectuer (D 0 · C 1 · B 2 · A 4 · S 8 · S+ 16). Quand ils sont tous publiés, le post est requalifié sur m, la moyenne de leurs vues. Un changement manuel repart sur un cycle neuf — la prochaine requalification reprend la main.",
      tierPassages_one: "{{count}} passage à effectuer",
      ...
      noteImport: "Note d'import",
      eloVide: "Pas encore de note (rejeté ou en cours d'import).",
      origine: "origine",
      nbPassages_one: "{{count}} passage",
      nbPassages_other: "{{count}} passages",
      decks: "Decks (par langue)",
      decksVide: "Aucun deck encore produit (import en cours ou jamais assigné).",
    ...
    reglages: {
      ...
      actionEloDesc:
        "Rattrapage ELO (actif) : scrape → deltas langue → classement des comptes. Le runtime minuit « scores » est en pause.",
      ...
      classementParams: "Classement des comptes",
      classementParamsAide:
        "Seuils de requalification des comptes (INACTIF → STAR), appliqués chaque nuit après le relevé des vues. Fenêtre = les N derniers posts.",
      clFenetre: "Fenêtre (derniers posts)",
      clMinEchantillon: "Échantillon minimum",
      clMinEchantillonAide:
        "Sous ce nombre de posts prévus (ou mesurés), le compte reste PASSABLE — on ne juge pas un compte neuf.",
      clRatioInactif: "INACTIF si postés ≤ (sur 10)",
      clRatioBien: "BIEN si postés ≥ (sur 10)",
      clRatioStar: "STAR si postés ≥ (sur 10)",
      clVuesMauvaises: "MAUVAISES VUES sous (vues)",
      clVuesBien: "BIEN à partir de (vues)",
      clVuesStar: "STAR au-delà de (vues)",
      clTrialHeures: "Durée de l'essai (heures)",
      clTrialAlerte: "Entrée en surveillance avant la fin (heures)",
      clSkipJours: "Durée d'un skip (jours)",
      nudgesTitre: "Messages prédéfinis (nudges)",
      nudgesAide:
        "Messages envoyables depuis la surveillance. Ils arrivent dans l'espace du créateur.",
      nudgeTitreChamp: "Titre",
      nudgeCorpsChamp: "Message",
      nudgeAjouter: "Ajouter un message",
      nudgeSupprimer: "Supprimer",
      nudgeVide: "Aucun message prédéfini.",
      ...
      actionPapier: "Papier CM",
      actionPapierDesc:
        "Bibliothèque de masters FR : durée, voix ElevenLabs, pause auto, plafond Fal.",
      papierPause: "Mettre le papier en pause (cron + auto-chaîne)",
      papierPauseAide:
        "Minuit n’assigne plus et ne crée plus d’original de secours. Les boutons de /admin/papier restent actifs. Le quota Fal continue de s’appliquer.",
      papierDuree: "Durée",
      papierDureeSec: "Durée cible (secondes)",
      papierDureeClip: "Durée d’un plan Seedance",
      papierClipAuto: "Auto (selon le texte)",
      papierDureeAide: "20–90 s au total. Auto aligne chaque plan sur le texte (4–15 s), puis coupe à la voix.",
      papierVoix: "Voix ElevenLabs",
      papierVoixDefaut: "Voix par défaut",
      papierVoixSuivre: "Suivre le défaut",
      papierVoixFavoris:
        "Langue puis locuteur. FR : Narration Papier, Nova, Marishnou. EN : Peter, Brady. L’étoile (page Papier) les met en tête.",
      papierCategorie: "Catégorie de sujet par défaut",
      papierStyle: "Style de narration par défaut",
      papierMode: "Mode pipeline par défaut",
      papierQuota: "Quota Fal / jour (0 = illimité)",
      papierQuotaAide: "Compte Nano Banana, Seedance, TTS, mix, assemblage et karaoké.",
      papierQuotaUsage: "{{n}} / {{max}} appels aujourd’hui",
      papierQuotaIllimite: "{{n}} appels aujourd’hui (illimité)",
    ...
    prompts: {
      scriptGenerationTitle: "Prompt — Génération de script",
      scriptGenerationDesc: "Choix du sujet, structure du script et découpage en plans.",
      voiceDeliveryTitle: "Prompt — Voix & débit",
      voiceDeliveryDesc: "Vitesse, ton et respiration de la voix off.",
      ctaSophiaTitle: "Prompt — CTA Sophia",
      ctaSophiaDesc: "La ligne de fin qui renvoie vers l'appli Sophia.",
      imageStyleTitle: "Prompt — Style des images",
      imageStyleDesc: "Direction artistique appliquée à chaque plan généré.",
    ...
    analytics: {
      ...
      parCompteDesc:
        "Classe par vues, classement ou likes. Les chiffres se mettent à jour après un refresh stats.",
    ...
    classement: {
      inactif: "INACTIF",
      mauvaises_vues: "MAUVAISES VUES",
      passable: "PASSABLE",
      bien: "BIEN",
      star: "STAR",
      aide: "Case du compte, requalifiée chaque nuit sur ses 10 derniers posts",
      maj: "Requalifié {{date}}",
      jamais: "Pas encore requalifié",
      verrou: "Case posée à la main",
    ...
    surveillance: {
      ...
      subtitle:
        "Les comptes en INACTIF ou MAUVAISES VUES, plus les essais qui arrivent à échéance. Requalification chaque nuit, après le relevé des vues.",
      fileTitre: "File de surveillance",
      fileDesc:
        "Un compte entre ici dès qu'il est INACTIF ou en MAUVAISES VUES, et obligatoirement 30 h avant la fin de son essai.",
      fileVide: "Personne dans la file — tous les comptes suivis sont au moins PASSABLE.",
      nonRenouvTitre: "Ne pas renouveler",
      nonRenouvDesc:
        "Comptes proposés au non-renouvellement. Aucun effet technique : ils continuent à recevoir leurs posts jusqu'à désactivation manuelle.",
      nonRenouvVide: "Aucun compte proposé au non-renouvellement.",
      compteur: "{{n}} compte(s)",
      ...
      annulerSkip: "Annuler le skip",
      changerCase: "Changer la case",
      changerCaseAide:
        "Pose la case à la main et verrouille le compte : la requalification de la nuit ne l'écrasera plus.",
      deverrouiller: "Rendre à l'auto",
      deverrouillerAide: "Le compte reprend la case calculée à la prochaine requalification.",
      nudge: "Nudge",
      nudgeAide: "Dépose un message interne que le créateur verra dans son espace.",
      nudgeAucunModele: "Aucun message prédéfini — ajoute-en dans Réglages.",
      nudgeEnvoye: "Message envoyé à {{nom}}.",
      nudgeDernier: "Dernier nudge {{date}}",
      nePasRenouveler: "Ne pas renouveler",
      nePasRenouvelerAide: "Ajoute le compte à la liste de non-renouvellement (sans rien couper).",
      retirerNonRenouv: "Retirer de la liste",
      hmDemande: "J'ai demandé au HM de ne pas renouveler ce compte",
    ...
    adminCreateur: {
      ...
      voirSurveillance: "Surveillance des comptes",
    ...
    recrutements: {
      title: "Recrutements",
      subtitle:
        "Pipeline des hiring managers et de leurs créateurs, par pays OS. Remplace le Google Sheet.",
      dernierRun: "Dernier passage autom : {{date}}",
      erreurCharge: "Impossible de charger Recrutements.",
      compteursPays: "0 · {{p0}}   1 · {{p1}}   2 · {{p2}}",
      retour: "Tous les pays",
      resumePays: "{{hms}} HM · {{createurs}} créateurs",
      cibleHm: "Cible créateurs",
      tousPostes: "Tous les créateurs de ce pays ont déjà posté — voir Suivi.",
      ficheCreateur: "Fiche créateur",
      ficheEmail: "Email",
      ficheTiktok: "Compte TikTok",
      ficheLabels: "Labels",
      ficheAucunTiktok: "Pas encore de compte TikTok.",
      ficheAucunLabel: "Aucun label",
      ficheOuvrirCompte: "Ouvrir le compte",
      phase0: "Phase 0 — Recruter le HM",
      phase1: "Phase 1 — Le HM recrute",
      phase2: "Phase 2 — Suivi",
      phaseCourt: "Phase {{n}}",
      phaseTitre0: "Recruter le HM",
      phaseTitre1: "Le HM recrute",
      phaseTitre2: "Suivi",
      pill0: "Recruter",
      pill1: "Recrute",
      pill2: "Suivi",
      createursCibleLabel: "Créateurs",
      createursCible: "{{n}} / {{cible}}",
      colPosts: "Posts 10 j",
      colVues: "Vues moy.",
      colCpm: "$ / 1k",
      videPhase: "Personne ici pour l’instant.",
      copier: "Copier",
      copie: "Copié",
      emailPerso: "Email perso",
      emailPersoAide: "Pour l’ajouter à l’équipe Upwork (copie-colle côté admin).",
      ajouteUpwork: "Ajouté à l’équipe Upwork (manuel)",
      nCreateurs_one: "{{count}} créateur",
      nCreateurs_other: "{{count}} créateurs",
      aucunCreateurPipeline: "Pas encore de créateur dans ce pays — relance le job post.",
      inboxTitre: "Inbox suggestions",
      inboxCarte: "Suggestion",
      ouvrirDetails: "Détails",
      replier: "Replier",
      nAValider_one: "{{count}} à valider",
      nAValider_other: "{{count}} à valider",
      dernierMessage: "Dernier message Upwork",
      ...
      etapesManuelles: "Étapes (coche à la main)",
      etapesManuellesAide:
      ...
      etape0Aide: {
        talks: "Premier vrai échange Upwork (invitation ou proposition spontanée).",
        contrat_envoye: "Contrat hourly 8 $/h envoyé sur Upwork.",
        contrat_signe: "Le HM a signé le contrat hourly.",
        acces: "Créer le compte OS, envoyer les codes, l’invite Slack, et demander l’email perso.",
        checklist: "Iel a rejoint Slack et l’OS, et tu l’as ajouté à l’équipe Upwork.",
        job_post: "Iel a posté un job sur l’org Vik Studios.",
      },
      etapeCreAide: {
        talks: "Premier échange avec ce créateur, dans ce pays / cette langue.",
        contrat: "Contrat créateur envoyé puis signé (essai 15 $, puis 60 $/mois).",
        acces: "Codes OS + invite Slack envoyés au créateur.",
        rejoint: "Le créateur a rejoint l’OS et le Slack Sophia.",
        warmup: "Le compte du pays est en warmup (ou l’a terminé).",
        premier_post: "Premier post publié (hors test) sur un compte de ce pays.",
      },
      sous: {
        codes: "Codes OS envoyés",
        slackInvite: "Invite Slack envoyée",
        emailDemande: "Email perso demandé",
        rejointOs: "A rejoint l’OS",
        rejointSlack: "A rejoint Slack",
        contratEnvoye: "Contrat envoyé",
        contratSigne: "Contrat signé",
      },
      valider: "Valider",
      reproposer: "Reproposer",
      ignorer: "Ignorer",
      faitManuellement: "Fait manuellement",
      relancer: "Relance",
      pression: "Pression",
      ...
      statut: {
        ...
        ignoree: "Ignorée",
        executee: "Exécutée",
        a_reproposer: "À reproposer",
      },
      ton: {
        ok: "OK",
        volume: "Sous-quota",
        vues: "0 vue",
        doux: "Sous-quota, grosses vues",
      },
    },
    referral: {
      ...
      condContact: "Donne son lien Upwork, son email ou son numéro de téléphone.",
      ...
      formSous: "Un seul contact suffit : Upwork, email ou téléphone.",
      prenom: "Prénom",
      nom: "Nom (optionnel)",
      ...
      email: "Email",
      telephone: "Téléphone",
      contactAide: "Remplis au moins un des trois contacts.",
      ...
      err: {
        ...
        contact: "Donne au moins un contact : Upwork, email ou téléphone.",
