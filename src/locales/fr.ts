export const fr = {
  translation: {
    ...
    papier: {
      ...
      modeManuel: "Manuel",
      modeAide:
        "Automatique : tout s’enchaîne. Manuel : tu valides le sujet, puis le script, puis le montage part.",
      ...
      holdScript: "Script prêt — relis le hook et l’histoire, puis lance le montage.",
      scriptHook: "Hook",
      scriptCta: "CTA",
      etape: {
        topic: "Sujet",
