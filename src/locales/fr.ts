export const fr = {
  translation: {
    ...
    minuit: {
      ...
      enCours: "Assignation…",
      lance: "Assignation relancée : {{crees}} post(s) créé(s). Le suivi ci-dessous se met à jour tout seul.",
      ...
      parCompteDesc: "Chaque compte actif, son quota du jour, et l'avancement de chaque post.",
