  ...
  translation: {
    ...
    ugc: {
      ...
      videos: {
        title: "AI Videos",
        subtitle:
          "Reactions: TikTok import → duration trim → 10th frame + OCR → save.",
        bientot: "Coming soon — UGC AI video generation.",
        importTitre: "Import a reaction",
        importDesc:
          "Paste a TikTok link. Apify scrapes and downloads the video, then you trim the duration by hand.",
        lien: "TikTok link",
        importer: "Import",
        importEnCours: "Apify import running…",
        titreChamp: "Title",
        cropAide:
          "Cut start and end: only the selected duration is saved (frame size unchanged).",
