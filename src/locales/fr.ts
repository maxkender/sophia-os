export const fr = {
  translation: {
    ...
    cm: {
      ...
      ajouterCompteAide:
        "Un créateur = un login. Tu peux lui rattacher plusieurs comptes TikTok de publication.",
      ajouterPersoAide:
    ...
    hiring: {
      ...
      creerHmDesc:
        "Même connexion et même mot de passe initial qu’un HM. Tu paramètres ses langues.",
    ...
    labels: {
      ...
      gestionDesc:
        "Pont entre contenus et créateurs.",
      nom: "Nom",
      couleur: "Couleur",
      genre: "Genre",
      genreHomme: "Homme",
