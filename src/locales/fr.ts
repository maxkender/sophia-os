export const fr = {
  translation: {
    ...
    papier: {
      ...
      voixAide:
        "Choisis d’abord la langue, puis un locuteur ElevenLabs. locuteur-cm (ta bibliothèque) est en tête du français. L’étoile enregistre un favori.",
      voixFavori: "Favori",
      voixEcouter: "Écouter un extrait",
      voixStop: "Arrêter",
      voixChargement: "Chargement des voix ElevenLabs…",
      voixSansCle:
        "Ajoute ELEVENLABS_API_KEY dans les secrets Supabase pour voir ta bibliothèque (locuteur-cm) et plus de voix françaises.",
    ...
    reglages: {
      ...
      papierDureeAide: "20–90 s au total. Auto choisit 4, 6 ou 8 s par plan.",
      papierVoix: "Voix ElevenLabs",
      papierVoixDefaut: "Voix par défaut",
      papierVoixSuivre: "Suivre le défaut",
      papierVoixFavoris:
        "Langue puis locuteur. locuteur-cm vient de ta bibliothèque ElevenLabs. L’étoile (page Papier) les met en tête.",
