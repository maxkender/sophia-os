 ...
 *
 * Cinq cases, de la pire à la meilleure : INACTIF · MAUVAISES VUES · PASSABLE ·
 * BIEN · STAR. Un compte est requalifié chaque nuit, à la fin du relevé des
 * vues (drain rattrapage), sur ses 10 derniers posts.
 *
 * Logique pure, partagée avec l'Edge : `supabase/functions/_shared/classement_comptes.ts`
 * en est la copie Deno, à garder synchro. Les tests vivent dans
 * `classementComptes.test.ts`.
 */
