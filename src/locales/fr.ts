export const fr = {
  translation: {
    ...
    papier: {
      ...
      voix: "Voix",
      voixAide: "Choisis une voix par langue dans les réglages. Ici : voix FR de ce master. L’étoile enregistre un favori.",
      voixFavori: "Favori",
    ...
    reglages: {
      ...
      papierVoixFavoris: "Favoris (affichés en premier)",
