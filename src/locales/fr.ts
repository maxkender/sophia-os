  ...
  translation: {
    ...
    ugc: {
      ...
      videos: {
        title: "Vidéos AI",
        subtitle:
          "Reactions : import TikTok → trim durée → 10ᵉ frame + OCR → enregistrement.",
        bientot: "Bientôt — génération de vidéos UGC AI.",
        importTitre: "Importer une reaction",
        importDesc:
          "Colle un lien TikTok. Apify scrape et télécharge la vidéo, puis tu coupes la durée à la main.",
        lien: "Lien TikTok",
        importer: "Importer",
        importEnCours: "Import Apify en cours…",
        titreChamp: "Titre",
        cropAide:
          "Coupe le début et la fin : seule la portion de durée sélectionnée est enregistrée (dimensions inchangées).",
